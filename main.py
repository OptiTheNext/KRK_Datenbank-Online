  ...
  if "Schreiben" in flask.request.form:
    ...
    if flask.request.method == 'POST': 
      ...
      if(sex == "" or SAPID == "" or Age=="" ):
        ...
        return flask.render_template('site_2.html',Topnav = True, startseite= False, error="Eingabe einkomplett")
      ...
      for ids in sid:
        ...
        if ids == (int(SAPID),):
          try:
            ...
            mydb.commit()
            return flask.render_template('site_2.html',Topnav = True, startseite= False,success = "Daten überschrieben")
          except:
...
def page_3():
    if("username" in flask.session):
      ...
      if "datenausgabe" in flask.request.form:
        ...
        htmltext = flask.Markup(df.style.set_table_styles([
              cell_hover,
              index_names,
              headers,
        ...
        return flask.render_template('site_3.html',Topnav = True, startseite= False, htmltext = htmltext)
